...
export type SiteSettings = { siteName:string; siteUrl:string; seoTitle:string; seoDescription:string; adsTxtContent:string; logoAssetId?:string|null; faviconAssetId?:string|null; socialImageAssetId?:string|null; logoUrl?:string|null; faviconUrl?:string|null; socialImageUrl?:string|null };
